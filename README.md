...
O dashboard e renderizado automaticamente usando a função logsDashboard(app). o dashboard usa a pasta logs gerada automaticamente pela blibioteca e os parametros de "requestLogger": { "enabled": true } em config.json
